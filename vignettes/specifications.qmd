...
Note that the input types *coordmat* -> *coorddat* -> *sfpoints* represent a natural order of promotion. If a method is described for a lower rank type, it is automatically assumed that without the addition of other parameters, the methods for the higher-rank types are implemented as well.
...
The metrics are implemented with the `occupancy` generic function. Occupancy is the numer of spatial structures (`s`) that are occupied by a set of coordinates. These spatial structures can be implied, named localities as well as irregular and regular (grids) sets of spherical polygons.

### Overview of occupancy methods

| Status | Method                         | Args                         | Description                                                                                                                                                                           |
|--------|--------------------------------|------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ✅     | `x`: *coordmat*  `s`:`missing` |                              | [<small>Number of occupied coordinate pairs </small>](#number-of-occupied-coordinate-pairs)                                                                                           |
| ✅     | `x`: *coorddat*  `s`:`missing` | `tax`   `long`, `lat`        | [<small>Number of occupied coordinate pairs iterated for taxa</small>](#number-of-occupied-coordinate-pairs-iterated-for-taxa)                                                        |
| ✅     | `x`: *coorddat*, `s`:`char`    |                              | [<small>Number of occupied named localities</small>](#number-of-occupied-named-localities)                                                                                            |
| ✅     | `x`: *coorddat*, `s`:`char`    | `tax`                        | [<small>Number of occupied named localities, iterated for taxa</small>](#number-of-occupied-named-localities-iterated-for-taxa)                                                       |
| ✅     | `x`: *coordmat*, `s`:`icosa`   | `q=1`, `long`, `lat`         | [<small>Occupied grid cells in an icosahedral grid based on point data</small>](#occupied-grid-cells-in-an-icosahedral-grid-based-on-point-data)                                      |
| ✅     | `x`: *coorddat*, `s`:`icosa`   | `tax`, `q=1`, `long`, `lat`  | [<small>Occupied grid cells in an icosahedral grid based on point data, iterated for taxa</small>](#occupied-grid-cells-in-an-icosahedral-grid-based-on-point-data-iterated-for-taxa) |
| ❓     | `x`: *coordmat*, `s`:`icosa`   | `q<1`, `method`="min"        | [x](#occupied-grid-cells-in-an-icosahedral-grid,-with-a-confidence-cut-off)                                                                                                           |
| ❓     | `x`: *coorddat*, `s`:`icosa`   | `tax`, `q<1`, `method`="min" | [x](#occupied-grid-cells-in-an-icosahedral-grid,-with-a-confidence-cut-off-iterated-for-taxa)                                                                                         |
| ❌     | `x`: *coordmat*, `s`:`sf`      | `q=1`                        | [x](#occupied-polygons-in-an-sf-or-sfc-polygon/multipolygon-object)                                                                                                                   |
| ❌     | `x`: *coorddat*, `s`:`sf`      | `tax`, `q=1`                 | [x](#occupied-polygons-in-an-sf-or-sfc-polygon/multipolygon-object-iterated-for-taxa)                                                                                                 |
| ❌     | `x`: *rast*                    | `threshold`=0                | [x](#occupied-cells-in-a-SpatRaster-object)                                                                                                                                           |
| ❌     | `x`: *rast*, `s`:`icosa`       | `threshold`=0                | [x](#occupied-cells-in-an-icosahedral-grid-based-on-a-SpatRaster-object)                                                                                                              |
| ❌     | `x`: *rast*, `s`:`sf`          | `threshold`=0                | [x](#occupied-polygons-based-on-a-SpatRaster-object)                                                                                                                                  |

: Occupancy methods {tbl-colwidths="[5,30, 30, 35]"}
