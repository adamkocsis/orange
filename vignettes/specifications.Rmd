...
- `icosa`: An icosahedral grid object defined with either `icosa::hexagrid` or `icosa::trigrid`  
...
|----|--------------------------|------------------------|-----------------------|------------------------------------------------------|
| ❌ | `occupancy_coords`       | `x`: *coords*          | `tax`                 | Number of occupied coordinate pairs for every entry. |
| ✅ | `occupancy_coords_icosa` | `x`: *coords*, `icosa` | `q`=NULL              | Number of occupied grid cells.                       |
| ✅ | `occupancy_coords_icosa` | `x`: *coords*, `icosa` | `q`=q, `method`="min" | Expected number of occupied grid cells.              |
| ❌ | `occupancy_coords_sfc`   | `x`: *coords*, `sf`    | `q`=NULL              | Number of occupied features.                         |
| ❌ | `occupancy_coords_sfc`   | `x`: *coords*, `sf`    | `q`=q                 | Expected number of features.                         |
