...
- `loc`: A location label in *coorddat*
...
- 2. **Methods** that inovke an internal logic applicable for as set of input classes. 
...
|----|--------------------------|--------------------------|-----------------------|------------------------------------------------------|
| ✅ | `occupancy_coords`       | `x`: *coorddat*          | `tax`                 | Number of occupied coordinate pairs for every entry. |
| ✅ | `occupancy_coords`       | `x`: *coorddat*, `loc`   | `tax`, `long`, `lat`  | Number of occupied localities.                       |
| ✅ | `occupancy_coords_icosa` | `x`: *coordmat*, `icosa` | `q=1`                 | Number of occupied grid cells.                       |
| ✅ | `occupancy_coords_icosa` | `x`: *coorddat*, `icosa` | `q=1`, `long`, `lat`  | Number of occupied grid cells.                       |
| ❓ | `occupancy_coords_icosa` | `x`: *coordmat*, `icosa` | `q<1`, `method`="min" | Expected number of occupied grid cells.              |
| ❓ | `occupancy_coords_icosa` | `x`: *coorddat*, `icosa` | `q<1`, `method`="min" | Expected number of occupied grid cells.              |
| ❌ | `occupancy_coords_sfc`   | `x`: *coordmat*, `sf`    | `q=1`                 | Number of occupied features.                         |
| ❌ | `occupancy_coords_sfc`   | `x`: *coordmat*, `sf`    | `q=q`                 | Expected number of features.                         |
| ❌ | `occupancy_rast_icosa`   | `x`: *rast*, `icosa`     | `threshold`=0         | Number of occupied grid cells.                       |
| ❌ | `occupancy_rast_sfc`     | `x`: *rast*, `sf`        | `threshold`=0         | Number of occupied features.                         |
