...
|    | Internal Name    | Method                         | Args                  | What it does                                                   |
|----|------------------|--------------------------------|-----------------------|----------------------------------------------------------------|
| ✅ | `maxdist_coords` | `x`: *coordmat*                | `q=1`                 | The maximum great circle distance in a point set.              |
| ✅ | `maxdist_coords` | `x`: *coorddat*                | `q=1`,  `long`, `lat` | The maximum great circle distance in a point set `data.frame`. |
