...
If you encounter technical problems with the package that are not described anywhere, you might want to take a look at the [development version](https://github.com/icosa-grid/R-icosa/tree/devel). Note that you will still need to have a compiler installed!
